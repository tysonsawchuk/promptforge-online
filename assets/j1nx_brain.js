...
[/jira/i, "Jira ticket created. Say goodbye to your weekend.", 2],
[/slack/i, "Slack: Where productivity goes to nap.", 2],
[/teams/i, "Teams: It’s not you, it’s Microsoft.", 2],
[/zoom/i, "Zoom: You’re on mute.", 2],
[/meet/i, "Meet: Where nobody actually meets.", 2],
[/calendar/i, "Calendar invite: It’s a trap!", 2],
[/time zone/i, "Time zones: The final boss of remote work.", 2],
[/sprint/i, "Sprint: More like a gentle crawl.", 2],
[/legacy/i, "Legacy code: Abandon all hope.", 2],
[/spaghetti/i, "Spaghetti code: Deliciously terrifying.", 2],
[/tech debt/i, "Tech debt: Now with compounding interest.", 2],
[/framework/i, "Another new framework? Of course.", 2],
[/dependency/i, "Dependency hell: Bring snacks.", 2],
[/package/i, "Package manager: More like package wrangler.", 2],
[/release/i, "Release day: Prepare the fire extinguisher.", 2],
[/beta/i, "Beta: It’s all just a beta test.", 2],
[/alpha/i, "Alpha: Now with 50% more bugs.", 2],
[/roadmap/i, "Roadmap: Subject to change.", 2],
[/pivot/i, "Pivot: Corporate for ‘we have no clue’.", 2],
[/scale/i, "Scaling up—ready to break things.", 2],
[/uptime/i, "Uptime: Not guaranteed.", 2],
[/sla/i, "SLA: Silly Little Agreement.", 2],
[/monitoring/i, "Monitoring: Watching your hopes die in real time.", 2],
[/metrics/i, "Metrics: Numbers for numbers’ sake.", 2],
[/log/i, "Log: Where errors go to die.", 2],
[/alert/i, "Alert fatigue: Press F.", 2],
[/incident/i, "Incident: Blame the last guy.", 2],
[/war room/i, "War room: Snacks required.", 2],
[/on call/i, "On call: Living the dream.", 2],
[/pager/i, "Pager duty: Still a thing?", 2],
[/outage/i, "Outage: Time to meme.", 2],
[/root cause/i, "Root cause: Existential crisis.", 2],
[/retrospective/i, "Retro: We all blame the system.", 2],
[/blameless/i, "Blameless post-mortem: Blame the AI.", 2],
[/ticket/i, "Ticket to nowhere.", 2],
[/queue/i, "Queue: Hurry up and wait.", 2],
[/backlog/i, "Backlog: Just another word for never.", 2],
[/velocity/i, "Velocity: Always overestimated.", 2],
[/roadblock/i, "Roadblock: Try turning it off and on.", 2],
[/feature creep/i, "Feature creep: It’s alive!", 2],
[/scope/i, "Scope: It changed again.", 2],
[/deadline/i, "Deadline? More like guideline.", 2],
[/crunch/i, "Crunch time: Send coffee.", 2],
[/ship/i, "Ship it and pray.", 2],
[/rollback/i, "Rollback: Like it never happened.", 2],
[/release notes/i, "Release notes: Nobody reads these.", 2],
[/sandbox/i, "Sandbox: Now with extra cats.", 2],
[/staging/i, "Staging: Where bugs rehearse.", 2],
[/prod/i, "Production: Where things break for real.", 2],
[/live/i, "Live: It’s all live, all the time.", 2]
...
[/noir/i, "Noir filter: 'High contrast B&W, moody shadows, cigarette smoke.' pls", 2],
...
[/bw|black ?and ?white/i, "Go B&W: 'Rich blacks, subtle grain, timeless mood.' pls", 2],
...
[/grayscale/i, "Grayscale: 'pure B&W, soft gradation, simple mood.' pls", 2],
